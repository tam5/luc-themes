...
(defconst luc-theme-faces
  '(
    ...
    (linum-leading-zero (:background background-color :foreground background-color :distant-foreground background-color))
   ...
   (diredp-dir-priv (:foreground function-color :background nil))
   (diredp-exec-priv (:foreground error-color :background nil))
   (diredp-read-priv (:foreground success-color :background nil))
   (diredp-write-priv (:foreground warning-color :background nil))
   (diredp-link-priv (:background nil :foreground variable-color))
   ...
   (diredp-number (:foreground primitive-color))
   (diredp-date-time (:foreground comment-color))
